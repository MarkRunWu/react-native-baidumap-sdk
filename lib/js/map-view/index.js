...
var BaiduMapUtil = react_native_1.NativeModules.BaiduMapUtil;
var events = ["onLoad", "onClick", "onLongClick", "onDoubleClick", "onStatusChange"];
var MapView = /** @class */ (function (_super) {
    ...
    MapView.prototype.pointForCoordinate = function (coordinate) {
        if (react_native_1.Platform.OS === "android") {
            return BaiduMapUtil.pointForCoordinate(react_native_1.findNodeHandle(this.map), coordinate);
        }
    };
    MapView.prototype.coordinateForPoint = function (point) {
        if (react_native_1.Platform.OS === "android") {
            return BaiduMapUtil.coordinateForPoint(react_native_1.findNodeHandle(this.map), point);
        }
    };
    MapView.prototype.render = function () {
        var _this = this;
        var props = __assign(__assign({}, this.props), this.handlers(events));
        return (<BaiduMapView ref={function (ref) {
            _this.map = ref;
        }} {...props}/>);
    };
